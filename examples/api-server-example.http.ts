/**
 * Example: API Server for Workflow Visualization (Val Town HTTP Val)
 *
 * This is a Val Town HTTP val that demonstrates:
 * 1. Setting up workflows with an API server using Hono
 * 2. Serving workflow data via REST API
 * 3. Creating and monitoring workflow runs
 * 4. Serving a React-based frontend visualizer
 *
 * This val is ready to deploy on Val Town!
 */
